...
public class ProjetoFinalOO {
    ...
    private static void abrirContabilidade() {
        ...
        if(resposta){
            ...
            JOptionPane.showMessageDialog(null, "N찾o foi poss챠vel abrir contabilidade");
        }
    ...
    private static Contabilidade pesquisarContabilidade() {
        ...
        if(cont == null){
            JOptionPane.showMessageDialog(null, "Contabilidade n찾o encontrada");
        }
        return cont;
       ...
       boolean deletado = false;
        ...
        if(confirma == JOptionPane.YES_OPTION){
         ...
         if(deletado){
            ...
            JOptionPane.showMessageDialog(null, "Contabilidade n찾o foi fechada");
        }
        }
    }
